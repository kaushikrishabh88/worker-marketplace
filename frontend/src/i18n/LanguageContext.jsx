...
const reverseUiTranslations = Object.fromEntries(
  Object.entries(uiTranslations).map(([english, hindi]) => [hindi, english])
);
...
function translateText(text, language) {
  ...
  const dictionary = language === "hi" ? uiTranslations : reverseUiTranslations;
...
function translateElement(root, language) {
  ...
  if (root.nodeType === Node.TEXT_NODE) {
    ...
    if (
      ...
      const translated = translateText(root.nodeValue || "", language);
