...
app.get("/", (req, res) => {
  res.json({
    success: true,
    message:
      "Worker Marketplace Backend is running!",
  });
});
    ...
    try {
      if (req.user.role !== "employer") {
        return res.status(403).json({
          success: false,
          message:
            "Only employer accounts can update employer profiles.",
        });
      }
    ...
    try {
      if (req.user.role !== "employer") {
        return res.status(403).json({
          success: false,
          message:
            "Only employer accounts can delete employer accounts.",
        });
      }
      ...
      return res.status(200).json({
        success: true,
        message:
          "Employer account deleted successfully.",
      });
    } catch (error) {
      console.error(
    ...
    try {
      ...
      if (
        ...
        return res
          ...
          .json({
            success: false,
            message:
              "This worker profile is not linked to a user account.",
          });
      }
      ...
      res
        ...
        .json({
          success: true,
          message:
            `Your request has been sent to ${workerName}.`,
          request:
            contactRequest,
        });
    } catch (error) {
      ...
      if (
        ...
        return res
          ...
          .json({
            success: false,
            message:
              "Only employers can view sent requests.",
          });
      }
    ...
    try {
      if (
        ...
        return res
          ...
          .json({
            success: false,
            message:
              "Only workers can view received requests.",
          });
      }
      ...
      const requests =
        await ContactRequest.find(
          ...
          .populate(
            "worker",
            "name role location avatarFileId"
          )
          .sort({
            createdAt: -1,
          });
      ...
      if (
        ...
        return res
          ...
          .json({
            success: false,
            message:
              "Only workers can update request status.",
          });
      }
      ...
      if (
        ...
        return res
          ...
          .json({
            success: false,
            message:
              "A worker profile already exists for this account.",
          });
      }
...
app.put(
  ...
  async (req, res) => {
    try {
      ...
      if (
        ...
        return res
          ...
          .json({
            success: false,
            message:
              "This older worker profile is not linked to an account.",
          });
      }

      if (
        existingWorker.user.toString() !==
        ...
        return res
          ...
          .json({
            success: false,
            message:
              "You can only edit your own worker profile.",
          });
      }
      ...
      existingWorker.skills =
        skills;

      existingWorker.location =
        location.trim();

      existingWorker.experience =
        experience;

      existingWorker.availability =
        availability;

      existingWorker.description =
        description
          ?.trim() ||
        "";

      existingWorker.salary =
        numericSalary;

      if (emoji) {
        existingWorker.emoji =
          emoji;
      }
      ...
      if (
        ...
        return res
          ...
          .json({
            success: false,
            message:
              "All required job fields are required.",
          });
      }
    ...
    try {
      const jobs =
        await Job.find({
          ...
          .populate(
  "employer",
  "name email avatarFileId businessName location"
)
          .sort({
            createdAt:
              -1,
    ...
    try {
      if (
        ...
        return res
          ...
          .json({
            success: false,
            message:
              "Only employers can view their job posts.",
          });
      }
      ...
      res
        ...
        .json({
          success: false,
          message:
            "Failed to fetch your job posts.",
        });
    }
  }
);
      ...
      if (
        ...
        return res
          ...
          .json({
            success: false,
            message:
              "Only employers can view job applicants.",
          });
      }
      ...
      if (
        ...
        return res
          ...
          .json({
            success: false,
            message:
              "You can only edit your own job posts.",
          });
      }
      ...
      if (
        ...
        return res
          ...
          .json({
            success: false,
            message:
              "Please provide valid job details.",
          });
      }
      ...
      if (
        ...
        return res
          ...
          .json({
            success: false,
            message:
              "Please create your worker profile before applying.",
          });
      }
      ...
      if (
        ...
        return res
          ...
          .json({
            success: false,
            message:
              "The job for this application no longer exists.",
          });
      }
    ...
    try {
      if (req.user.role !== "worker") {
        return res.status(403).json({
          success: false,
          message:
            "Only workers can view their applications.",
        });
      }
      ...
      const applications =
        await Application.find({
          ...
          .populate({
            ...
            select:
              "title skill location salary jobType status employer",
